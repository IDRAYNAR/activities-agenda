      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {activities.map((activity) => (
            ...
            >
              <div className="bg-white rounded-lg shadow-sm ring-1 ring-gray-200 hover:ring-violet-500 transition-all">
                <div className="p-6">
                  ...
                  <h2 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-violet-600">
                    {activity.name}
                  </h2>
