  ...
  return (
    <section className="bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 dark:text-gray-800">Explorez nos univers</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-3 dark:text-gray-800">Sports</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-3 dark:text-gray-800">Loisirs</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-3 dark:text-gray-800">Bien-être</h3>
            <p className="text-gray-600 mb-4">
